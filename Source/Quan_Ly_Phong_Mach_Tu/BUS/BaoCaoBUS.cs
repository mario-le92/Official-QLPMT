...
namespace BUS
{
    public class BaoCaoBUS
    {
        ...
        public CRSuDungThuoc getCRSuDungThuoc(string thang, string nam)
        {
            CRSuDungThuoc cr = new CRSuDungThuoc();
            //cr.RecordSelectionFormula = "{Hoa_Don.Ngay_kham} in DateTime (2015, 03, 01, 0, 0, 0) to DateTime (2015, 03, 31, 0, 0, 0)";
            return cr;
        }
    }
}
